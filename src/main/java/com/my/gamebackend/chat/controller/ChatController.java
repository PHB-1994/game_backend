...
public class ChatController {
    ...
    public ResponseEntity<List<ChatMessage>>  getUserConversationHistory(@PathVariable Long conversationId){
        try{
    ...
    /**
     * 사용자의 모든 대화방 기록 메세지 조회
     * GET /api/chat/conversations/{userId}
     */
    @GetMapping("/conversations/{userId}")
    public ResponseEntity<List<ChatConversation>>  getUserConversations(@PathVariable String userId){
        try{
